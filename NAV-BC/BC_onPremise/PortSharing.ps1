# Script para activar el servicio de portSharing y autorizar a la cuenta de servicio a utilizarlo
# Orígen https://dynamics.is/?p=2291

#Modify User and Domain to fit your environment
$UserToAdd = ‘servicios’
$ServiceInstance = "CRONUS160"

# Activamos Portsharing en la instancia de BC
sc.exe config (get-service  "*$ServiceInstance").Name depend= HTTP/NetTcpPortSharing

# habilitamos la cuenta de servicio para utilizar PortSharing
...
$UserSid = (get-ciminstance win32_useraccount -filter "Name = $UserToAdd").Sid
