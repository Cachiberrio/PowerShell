...
Add-Type -Path "C:\Program Files\WindowsPowerShell\Modules\AzureAD\2.0.2.130\Microsoft.IdentityModel.Clients.ActiveDirectory.dll"
$aadAppId = "a19cb26a-2e4c-408b-82e1-6311742ecc50"
$aadAppRedirectUri = "nativeBusinessCentralClient://auth"

$outputFilePath = "c:\AppReport.csv"
