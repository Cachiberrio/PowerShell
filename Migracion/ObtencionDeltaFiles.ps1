...
$FicheroDestino   = 'C:\Tipsa\PowerShell\Migracion\Objetos\BC365 CU00.txt'

$FicheroCUOrigen  = 'C:\Tipsa\PowerShell\Migracion\Objetos\BC365 CU00.txt'
$FicheroCUDestino = 'C:\Tipsa\PowerShell\Migracion\Objetos\BC365 CU02.txt'

$MigracionConAddOn = $False
if ($MigracionConAddOn -eq $True)
   {
   $FicheroAddOnOrigen  = 'C:\Tipsa\PowerShell\Migracion\Objetos\VNTES7.10.01 en NAV2013R2 CU14.txt'
   $FicheroAddOnDestino = 'C:\Tipsa\PowerShell\Migracion\Objetos\VNTES7.10.02 en NAV2013R2 CU28.txt'
   }
else
   {
   $FicheroAddOnOrigen  = ' '
...
# =======================================================================================================================
$RutaModulo = 'C:\Program Files (x86)\Microsoft Dynamics 365 Business Central\130\RoleTailored Client CU02\NavModelTools.ps1'
